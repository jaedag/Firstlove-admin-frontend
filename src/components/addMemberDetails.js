                        ...
                        <div className="row">
                            <div className="col-md-4 ml-0 pl-0 justify-content-center">
                                <div className="card card-body justify-content-center">
                                  ...
                                  <button className="btn btn-primary btn-large my-3">Upload File</button>
                                </div>
                            </div>
                        ...
                        <div className="col mb-3 p-3">
                         ...
                         name='church'>
                            ...
                            <div className="col mb-3 p-3">                              
                              ...
                              onChange={handleInput}
                              name='ministry'>
                                <option defaultValue>Ministry</option>
                            ...
                            <div className="justify-content-center p-3 push align-bottom"
                            onClick={handleInput}
                            >
                                <button 
                                onClick={handleSubmit}
                                className="btn btn-primary btn-block my-3 align-baseline">Submit</button>
                            </div>
